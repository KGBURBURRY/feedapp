	...
	public void sendEmail() throws AddressException, MessagingException {
		   ...
		   Session session = Session.getInstance(props, new javax.mail.Authenticator() {
		      protected PasswordAuthentication getPasswordAuthentication() {
		         return new PasswordAuthentication("kegburberry@gmail.com", "gusgipsacbbevuwi"); //gusgipsacbbevuwi
		   ...
		   msg.setFrom(new InternetAddress("kegburberry@gmail.com", false));

		   msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("galal.karim@outlook.com"));
